...
declare -A LIBS
LIBS[cli]="libsmithcoin_cli.a"
LIBS[common]="libsmithcoin_common.a"
LIBS[consensus]="libsmithcoin_consensus.a"
LIBS[crypto]="libsmithcoin_crypto.a"
LIBS[node]="libsmithcoin_node.a"
LIBS[util]="libsmithcoin_util.a"
LIBS[wallet]="libsmithcoin_wallet.a"
...
# https://github.com/smithcoin/smithcoin/issues/10102
