...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef SMITHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define SMITHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the smithcoin network\n')
    ...
    g.write('#endif // SMITHCOIN_CHAINPARAMSSEEDS_H\n')
