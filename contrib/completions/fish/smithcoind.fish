...
complete --command smithcoind --no-files

# Extract options
function __fish_smithcoind_get_options
...
complete \
    --command smithcoind \
    --arguments "(__fish_smithcoind_get_options --nofiles)"
