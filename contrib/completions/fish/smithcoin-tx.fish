...
# Extract options
function __fish_smithcoin_tx_get_options
...
# Extract commands
function __fish_smithcoin_tx_get_commands
...
# Add options
complete \
    --command smithcoin-tx \
    --condition "not __fish_smithcoin_seen_cmd (__fish_smithcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_smithcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command smithcoin-tx \
    --arguments "(__fish_smithcoin_tx_get_commands)" \
    --no-files
