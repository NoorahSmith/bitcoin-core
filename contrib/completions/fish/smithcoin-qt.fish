...
complete --command smithcoin-qt --no-files

# Extract options
function __fish_smithcoinqt_get_options
...
complete \
    --command smithcoin-qt \
    --arguments "(__fish_smithcoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c smithcoin-qt \
...
complete \
    --command smithcoin-qt \
    --arguments "(__fish_smithcoinqt_get_options --nofiles)"
