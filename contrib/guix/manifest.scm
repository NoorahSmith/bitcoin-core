...
(define* (make-smithcoin-cross-toolchain target
                                       #:key
...
desirable for building Smithcoin Core release binaries."
...
;; failure; see https://github.com/smithcoin/smithcoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-smithcoin-cross-toolchain target)))
