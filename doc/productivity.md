...
```sh
cmake --build build --target smithcoind smithcoin-cli
cmake --build build --target smithcoin-qt
cmake --build build --target bench_smithcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:smithcoin/smithcoin.git
```
...
> e.g. github.com/smithcoin/smithcoin.git or for the GUI github.com/smithcoin-core/gui
