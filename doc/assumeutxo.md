...
Assumeutxo is a feature that allows fast bootstrapping of a validating smithcoind
instance.
...
```
$ smithcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ smithcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
