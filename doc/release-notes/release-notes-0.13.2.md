Smithcoin Core version 0.13.2 is now available from:

  <https://smithcoin.org/bin/smithcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update smithcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow smithcoin-tx to create v2 transactions (btcdrak)
