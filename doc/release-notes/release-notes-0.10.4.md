Smithcoin Core version 0.10.4 is now available from:

  <https://smithcoin.org/bin/smithcoin-core-0.10.4/>
...
- #6953 `43c2789` Split smithcoin-tx into its own package
- #6953 `dfe0d4d` Include smithcoin-tx binary on Debian/Ubuntu
