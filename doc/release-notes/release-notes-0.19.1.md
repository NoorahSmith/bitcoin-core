...
Smithcoin Core version 0.19.1 is now available from:

  <https://smithcoincore.org/bin/smithcoin-core-0.19.1/>
...
From Smithcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Smithcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Smithcoin Core does not yet change appearance when
...
- #17488 fix "smithcoind already running" warnings on macOS (fanquake)
