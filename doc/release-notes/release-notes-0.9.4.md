Smithcoin Core version 0.9.4 is now available from:

  https://smithcoin.org/bin/0.9.4/
...
this update is incompatible with the Smithcoin system and could lead to consensus
forks.

Smithcoin Core released binaries from https://smithcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~smithcoin/+archive/ubuntu/smithcoin
- A third-party or self-compiled Smithcoin Core

upgrade to Smithcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
