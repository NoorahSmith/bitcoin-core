Smithcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/smithcoin/files/Smithcoin/smithcoin-0.5.4/
...
http://gitorious.org/smithcoin/smithcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Smithcoin-Qt notifications under Growl 1.3.
Increase required age of Smithcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSmithcoin properly when installing Smithcoin-Qt over it. (Windows)
