Smithcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/smithcoin/files/Smithcoin/smithcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Smithcoin
...
New/changed settings (command-line or smithcoin.conf file)
--------------------------------------------------------
