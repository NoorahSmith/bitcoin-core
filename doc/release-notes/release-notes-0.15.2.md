Smithcoin Core version *0.15.2* is now available from:

  <https://smithcoincore.org/bin/smithcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in smithcoin-tx (TheBlueMatt)
