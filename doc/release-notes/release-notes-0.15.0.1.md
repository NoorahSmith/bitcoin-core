Smithcoin Core version *0.15.0.1* is now available from:

  <https://smithcoin.org/bin/smithcoin-core-0.15.0.1/>

and

  <https://smithcoincore.org/bin/smithcoin-core-0.15.0.1/>
