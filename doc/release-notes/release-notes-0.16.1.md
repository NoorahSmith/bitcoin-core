Smithcoin Core version 0.16.1 is now available from:

  <https://smithcoincore.org/bin/smithcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting smithcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure smithcoind processes are cleaned up when tests end (sdaftuar)
