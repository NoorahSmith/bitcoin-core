UNIX BUILD NOTES
====================
Some notes on how to build Smithcoin Core in Unix.
...
memory available when compiling Smithcoin Core. On systems with less, gcc can be
...
To build Smithcoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Smithcoin Core can
...
This example lists the steps necessary to setup and build a command line only distribution of the latest changes on Arch Linux:
    ...
    ./build/bin/smithcoind
    ./build/bin/smithcoin help
