...
The Smithcoin Core daemon can be configured to act as a trusted "border
router", implementing the smithcoin wire protocol and relay, making
...
The ZeroMQ feature in Smithcoin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ smithcoind -zmqpubhashtx=tcp://127.0.0.1:211001 \
               -zmqpubhashtx=tcp://192.168.1.2:211001 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=ipc:///tmp/smithcoind.tx.raw \
...
From the perspective of smithcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into smithcoind directly. Furthermore, no information is
...
using. Smithcoind appends an up-counting sequence number to each
