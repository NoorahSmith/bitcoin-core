# PSBT Howto for Smithcoin Core

Since Smithcoin Core 0.17, an RPC interface exists for Partially Signed Smithcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/smithcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Smithcoin transactions that are not fully signed
...
#### Multisig with multiple Smithcoin Core instances
