...
Smithcoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Smithcoin Core

**When configuring Smithcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Smithcoin Core:
...
variables will be set when generating the Smithcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
