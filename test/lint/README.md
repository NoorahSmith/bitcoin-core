...
```sh
DOCKER_BUILDKIT=1 docker build -t smithcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/smithcoin -it smithcoin-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/smithcoin-core/crc32c-subtree.git (branch smithcoin-fork)
* for `src/crypto/ctaes`: https://github.com/smithcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/smithcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/smithcoin-core/leveldb-subtree.git (branch smithcoin-fork)
* for `src/minisketch`: https://github.com/smithcoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/smithcoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/smithcoin-core/secp256k1.git
```
