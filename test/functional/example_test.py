...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SmithcoinTestFramework
    pass


class ExampleTest(SmithcoinTestFramework):
    # Each functional test is a subclass of the SmithcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SmithcoinTestFramework class so other tests can use it."""
