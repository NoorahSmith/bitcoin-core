...
class SmithcoinChainstateTest(SmithcoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_smithcoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing smithcoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    SmithcoinChainstateTest(__file__).main()
