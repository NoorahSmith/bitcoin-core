...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/smithcoin/smithcoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/smithcoin/smithcoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
