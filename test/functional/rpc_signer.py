...
Verify that a smithcoind node can use an external signer command.
...
class RPCSignerTest(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart smithcoind with -signer=<cmd>',
