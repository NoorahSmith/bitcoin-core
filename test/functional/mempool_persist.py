...
By default, smithcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent smithcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
