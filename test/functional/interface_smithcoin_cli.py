#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Smithcoin Core developers
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"smithcoin-cli -h\" for help or \"smithcoin-cli listwallets\" to see "
...
class TestSmithcoinCli(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `smithcoin-cli getblockchaininfo`")
        ...
        # Prevent smithcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and smithcoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and smithcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test smithcoin-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestSmithcoinCli(__file__).main()
