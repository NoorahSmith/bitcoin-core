#!/usr/bin/env python3
# Copyright (c) 2020-present The Smithcoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The smithcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        # smithcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that smithcoind sends its own version prior to processing
