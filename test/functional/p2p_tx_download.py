#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Smithcoin Core developers
...
class TxDownloadTest(SmithcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new smithcoind instances, as setting mocktimes has long-term effects on when
