...
class TestShell:
    """Wrapper Class for SmithcoinTestFramework.

    The TestShell class extends the SmithcoinTestFramework
    ...
    class __TestShell(SmithcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SmithcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # SmithcoinTestFramework instances are supposed to be constructed with the path
