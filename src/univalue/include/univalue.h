...
// Copyright 2015 Smithcoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
