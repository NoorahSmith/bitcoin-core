...
#ifndef SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // SMITHCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
