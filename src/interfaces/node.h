...
#ifndef SMITHCOIN_INTERFACES_NODE_H
#define SMITHCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a smithcoin node (smithcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or smithcoin.conf.
...
#endif // SMITHCOIN_INTERFACES_NODE_H
