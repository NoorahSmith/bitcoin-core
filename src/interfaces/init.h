...
#ifndef SMITHCOIN_INTERFACES_INIT_H
#define SMITHCOIN_INTERFACES_INIT_H
...
//! (smithcoin-gui, smithcoin-node, smithcoin-wallet, smithcoind, smithcoin-qt) and each
...
#endif // SMITHCOIN_INTERFACES_INIT_H
