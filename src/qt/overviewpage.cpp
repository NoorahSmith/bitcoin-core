...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = SmithcoinUnits::formatWithUnit(unit, amount, true, SmithcoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    SmithcoinUnit unit{SmithcoinUnit::BTC};
...
{
    SmithcoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(SmithcoinUnits::formatWithPrivacy(unit, balances.balance, SmithcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(SmithcoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, SmithcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(SmithcoinUnits::formatWithPrivacy(unit, balances.immature_balance, SmithcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(SmithcoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, SmithcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
