...
#ifndef SMITHCOIN_QT_OPTIONSMODEL_H
#define SMITHCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Smithcoin client.
...
public:
    ...
    SmithcoinUnit getDisplayUnit() const { return m_display_smithcoin_unit; }
...
private:
    ...
    QString language;
    SmithcoinUnit m_display_smithcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(SmithcoinUnit unit);
...
#endif // SMITHCOIN_QT_OPTIONSMODEL_H
