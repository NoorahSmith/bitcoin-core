...
#ifndef SMITHCOIN_QT_SENDCOINSENTRY_H
#define SMITHCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending smithcoins.
 */
...
#endif // SMITHCOIN_QT_SENDCOINSENTRY_H
