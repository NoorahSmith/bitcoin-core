...
#ifndef SMITHCOIN_QT_SMITHCOINGUI_H
#define SMITHCOIN_QT_SMITHCOINGUI_H
...
/**
  Smithcoin GUI main class. This class represents the main window of the Smithcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SmithcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SmithcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SmithcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a smithcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, SmithcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Smithcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(SmithcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // SMITHCOIN_QT_SMITHCOINGUI_H
