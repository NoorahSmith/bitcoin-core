...
#ifndef SMITHCOIN_QT_GUIUTIL_H
#define SMITHCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Smithcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "smithcoin:" URI into recipient object, return true on successful parsing
