      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->smithcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->smithcoinAtStartup);
    ...
    ui->smithcoinAtStartup->setToolTip(ui->smithcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->smithcoinAtStartup->setText(ui->smithcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openSmithcoinConfButton->setToolTip(ui->openSmithcoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new SmithcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->smithcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSmithcoinConfButton_clicked()
{
