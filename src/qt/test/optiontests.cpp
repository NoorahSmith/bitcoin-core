...
{
    // Test regression https://github.com/smithcoin/smithcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/smithcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/smithcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Smithcoin/Smithcoin-Qt.conf and all else left as default,
    // smithcoin-qt should set both -listen and -listenonion to false and start successfully.
