...
//! Entry point for SmithcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SmithcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SmithcoinGUI tests.
void AppTests::guiTests(SmithcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SmithcoinGUI::consoleShown, this, &AppTests::consoleTests);
