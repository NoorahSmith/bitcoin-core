...
/**
 * Port numbers for incoming Tor connections (11002, 11102, 31102, 41102, 11202) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 11001);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 11101);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 41101);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 31101);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 11201);
    }
    assert(false);
}
