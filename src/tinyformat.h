...
#include <algorithm>
#include <attributes.h> // Added for Smithcoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Smithcoin Core
#include <util/string.h> // Added for Smithcoin Core
...
// Added for Smithcoin Core. Similar to std::runtime_format from C++26.
...
// Added for Smithcoin Core. Wrapper for checking format strings at compile time.
