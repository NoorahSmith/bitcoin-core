...
#ifndef SMITHCOIN_COMMON_SIGNMESSAGE_H
#define SMITHCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's smithcoin address, it must refer to a public key.
...
#endif // SMITHCOIN_COMMON_SIGNMESSAGE_H
