...
// Copyright (c) 2009-2020 The Smithcoin Core developers
...
#ifndef SMITHCOIN_COMMON_MESSAGES_H
#define SMITHCOIN_COMMON_MESSAGES_H
...
#endif // SMITHCOIN_COMMON_MESSAGES_H
