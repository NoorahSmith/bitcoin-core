...
#ifndef SMITHCOIN_COMMON_ARGS_H
#define SMITHCOIN_COMMON_ARGS_H
...
extern const char * const SMITHCOIN_CONF_FILENAME;
extern const char * const SMITHCOIN_SETTINGS_FILENAME;
