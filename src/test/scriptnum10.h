...
#ifndef SMITHCOIN_TEST_SCRIPTNUM10_H
#define SMITHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Smithcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SMITHCOIN_TEST_SCRIPTNUM10_H
