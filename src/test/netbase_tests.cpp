...
{
    BOOST_CHECK(TestSplitHost("www.smithcoincore.org", "www.smithcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.smithcoincore.org]", "www.smithcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.smithcoincore.org:80", "www.smithcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.smithcoincore.org]:80", "www.smithcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.smithcoincore.org:65536", "www.smithcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.smithcoincore.org:0", "www.smithcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.smithcoincore.org:", "www.smithcoincore.org:", 0, false));
}
