// Copyright (c) 2019-2020 The Smithcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SMITHCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define SMITHCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // SMITHCOIN_TEST_UTIL_TRANSACTION_UTILS_H
