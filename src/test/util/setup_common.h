// Copyright (c) 2015-present The Smithcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SMITHCOIN_TEST_UTIL_SETUP_COMMON_H
#define SMITHCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/smithcoin/smithcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // SMITHCOIN_TEST_UTIL_SETUP_COMMON_H
