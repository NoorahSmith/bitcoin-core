...
extern thread_local ThreadContext g_thread_context; // NOLINT(smithcoin-nontrivial-threadlocal)
// Silence nonstandard smithcoin tidy error "Variable with non-trivial destructor
