...
#ifndef SMITHCOIN_IPC_CAPNP_COMMON_TYPES_H
#define SMITHCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between smithcoin processes.
...
//! Functions to serialize / deserialize common smithcoin types.
namespace mp {
...
#endif // SMITHCOIN_IPC_CAPNP_COMMON_TYPES_H
