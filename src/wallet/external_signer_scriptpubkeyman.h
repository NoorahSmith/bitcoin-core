...
#ifndef SMITHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define SMITHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // SMITHCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
