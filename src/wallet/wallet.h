...
#ifndef SMITHCOIN_WALLET_WALLET_H
#define SMITHCOIN_WALLET_WALLET_H
...
public:
     ...
     * smithcoin-wallet tool code or by wallet migration code. If this is called
...
#endif // SMITHCOIN_WALLET_WALLET_H
