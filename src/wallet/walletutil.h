// Copyright (c) 2017-2021 The Smithcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SMITHCOIN_WALLET_WALLETUTIL_H
#define SMITHCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! smithcoin from opening the wallet, thinking it was newly created, and
...
#endif // SMITHCOIN_WALLET_WALLETUTIL_H
