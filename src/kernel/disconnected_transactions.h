...
#ifndef SMITHCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define SMITHCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // SMITHCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
