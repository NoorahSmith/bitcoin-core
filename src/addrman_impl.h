...
#ifndef SMITHCOIN_ADDRMAN_IMPL_H
#define SMITHCOIN_ADDRMAN_IMPL_H
 ...
 * see https://smithcoincore.org/en/2024/07/31/disclose-addrman-int-overflow/
 */
...
#endif // SMITHCOIN_ADDRMAN_IMPL_H
