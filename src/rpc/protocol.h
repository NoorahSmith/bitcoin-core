...
#ifndef SMITHCOIN_RPC_PROTOCOL_H
#define SMITHCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in smithcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Smithcoin is not connected
...
#endif // SMITHCOIN_RPC_PROTOCOL_H
