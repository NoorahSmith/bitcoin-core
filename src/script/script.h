...
#ifndef SMITHCOIN_SCRIPT_SCRIPT_H
#define SMITHCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Smithcoin always counted CHECKMULTISIGs
...
#endif // SMITHCOIN_SCRIPT_SCRIPT_H
