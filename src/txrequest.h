...
#ifndef SMITHCOIN_TXREQUEST_H
#define SMITHCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://smithcoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
