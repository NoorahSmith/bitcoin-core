...
#ifndef SMITHCOIN_NODE_CONNECTION_TYPES_H
#define SMITHCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/smithcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Smithcoin’s Peer-to-Peer Network")
...
#endif // SMITHCOIN_NODE_CONNECTION_TYPES_H
