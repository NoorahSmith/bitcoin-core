...
#ifndef SMITHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SMITHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SMITHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
