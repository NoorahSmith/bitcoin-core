...
#ifndef SMITHCOIN_ARITH_UINT256_H
#define SMITHCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Smithcoin only uses this "compact" format for encoding difficulty
...
#endif // SMITHCOIN_ARITH_UINT256_H
